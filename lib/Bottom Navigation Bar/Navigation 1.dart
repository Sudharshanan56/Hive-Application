...
//   const navi_home({super.key, this.initialIndex = 0}); // Default is Home tab
...
class _navi_homeState extends State<navi_home> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          pages[_selectedIndex], // Main Content

          // Floating Bottom Navigation Bar
          Positioned(
            left: screenWidth * 0.05, // Adjust margin from left
            right: screenWidth * 0.05, // Adjust margin from right
            bottom: screenHeight * 0.02, // Elevate from bottom
            child: ClipRRect(
              borderRadius: BorderRadius.circular(30),
              child: Expanded(
                child: Container(
